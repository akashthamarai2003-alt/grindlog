      ...
      <div className="mx-auto mt-4 max-w-md px-6">
        ...
        <div className="mx-auto max-w-md px-6 pb-5 animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          <div className="mb-4 flex items-center justify-between">
            ...
            <span className="text-[10px] font-black text-emerald-400 bg-emerald-500/10 border border-emerald-500/20 px-2.5 py-1 rounded-full uppercase tracking-wider flex items-center gap-1 shrink-0">
              🍃 100% Natural Foods
            </span>
          </div>
