        ...
        >
          ...
          {confirmationNeeded ? (
            <motion.div
              ...
              className="rounded-xl bg-[#34C759]/20 border border-[#34C759]/50 p-5 text-white flex flex-col gap-3"
            >
              <div className="flex items-start gap-3">
                <AlertCircle className="h-5 w-5 shrink-0 text-[#34C759] mt-0.5" />
                <div className="flex flex-col gap-1.5">
                  <h2 className="font-bold text-base text-white">Check your email</h2>
              ...
              <Link
                href={`/auth/signin?email=${encodeURIComponent(cleanEmail)}`}
                className="mt-2 flex h-11 w-full items-center justify-center rounded-xl bg-white/20 border border-white/40 text-sm font-bold text-white transition-colors hover:bg-white/30"
              >
                Go to Login
              </Link>
            </motion.div>
