    ...
    <div className="flex min-h-dvh flex-col bg-[var(--color-bg-primary)] safe-top">
      ...
      <div className="flex flex-1 flex-col px-6 pt-4">
        ...
        >
          ...
          <Link
            ...
            className="self-end text-sm font-medium text-[var(--color-accent-green)]"
          >
            Forgot password?
          </Link>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.96 }}
            disabled={isLoading}
            className="mt-2 flex h-14 w-full items-center justify-center rounded-2xl bg-[var(--color-accent-green)] text-base font-semibold text-white shadow-lg shadow-[var(--color-accent-green)]/25 transition-all hover:brightness-105 disabled:opacity-50"
          >
            {isLoading ? (
              <motion.div
      ...
      <div className="px-6 pb-8 safe-bottom text-center">
        <p className="text-sm text-[var(--color-text-secondary)]">
          ...
          <Link href="/auth/signup" className="font-semibold text-[var(--color-accent-green)]">
            Sign up
          </Link>
        </p>
      </div>
