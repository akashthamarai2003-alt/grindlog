...
export function SwapMealModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-in fade-in duration-200">
      <div className="relative w-full max-w-lg max-h-[90vh] bg-[#111A10] border border-white/10 rounded-[28px] overflow-hidden flex flex-col shadow-2xl">
        
        {/* Header */}
        <div className="p-5 border-b border-white/10 flex items-center justify-between bg-black/20">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-[#ADFF00]/10 border border-[#ADFF00]/20 flex items-center justify-center text-[#ADFF00]">
              <RefreshCw size={18} />
            </div>
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-[9px] font-black uppercase bg-white/10 text-white/70 px-2 py-0.5 rounded-full border border-white/10">
                  {profileDiet}
                </span>
              </div>
              <p className="text-xs text-white/50 font-medium">
                Choose a balanced, healthy alternative for today
              </p>
            </div>
          </div>
          <button
