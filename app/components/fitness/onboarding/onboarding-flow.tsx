...
export function OnboardingFlow({ initialData = {}, sessionId }: { initialData?: Partial<OnboardingData>, sessionId?: string }) {
  ...
  const step2Errors = (() => {
    ...
    if (typeof data.preferred_language === 'string' && !data.preferred_language.trim()) {
      errs.preferred_language = "Please select your preferred language.";
    }
    return errs;
  })();
            ...
            <div className="space-y-6">
                ...
                <div>
                  ...
                  <input 
                    ...
                    onChange={e => {
                      ...
                      handleUpdate({ age: isNaN(val) ? undefined : val });
                    }}
                    className={`w-full p-4 rounded-xl border bg-[#0D150D] text-white transition-colors outline-none placeholder:text-gray-600 ${
              ...
              <div>
                ...
                <select
                  ...
                  className={`w-full p-4 rounded-xl border bg-[#0D150D] text-white transition-colors outline-none appearance-none ${
