  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none" style={{ zIndex: 1 }}>
      ...
      <div
        ...
        style={{
          background: "radial-gradient(ellipse at 50% 38%, #0a1f0a 0%, #061506 35%, #030a03 100%)",
        }}
      />
      ...
      <div
        ...
        style={{
          ...
          background: "radial-gradient(circle at 50% 38%, rgba(34,197,94,0.06) 0%, transparent 50%)",
        }}
      />
