...
export function ProgressHeader({ transformation, period, onPeriodChange }: ProgressHeaderProps) {
      ...
      <div className="w-full flex items-center justify-between bg-[#111A10] p-1.5 rounded-[16px] border border-white/5 overflow-x-auto snap-x hide-scrollbar">
        {periods.map(p => (
          <button
            ...
            className={`flex-1 min-w-[64px] px-3 py-2.5 rounded-[12px] text-[10px] font-black uppercase tracking-widest transition-all snap-center ${
              period === p 
