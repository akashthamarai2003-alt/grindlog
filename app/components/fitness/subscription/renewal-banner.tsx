...
export function RenewalBanner({ state }: { state: FitnessSubscriptionState }) {
  ...
  if (state.isGracePeriod) {
    return (
      <div className="fitness-renewal-banner fitness-renewal-grace relative overflow-hidden rounded-2xl border border-amber-500/40 bg-gradient-to-r from-[#241708] via-[#1a1205] to-[#241708] p-4 shadow-[0_0_25px_rgba(245,158,11,0.2)]">
        <div className="flex flex-col justify-between gap-3">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="fitness-renewal-description text-xs text-white/80 mt-1 leading-relaxed">
  ...
  if (state.isExpired) {
    return (
      <div className="fitness-renewal-banner fitness-renewal-expired relative overflow-hidden rounded-2xl border border-purple-500/40 bg-gradient-to-r from-[#1c0f24] via-[#120817] to-[#1c0f24] p-4 shadow-[0_0_25px_rgba(168,85,247,0.2)]">
        <div className="flex flex-col justify-between gap-3">
          <div className="flex items-start gap-3">
  ...
  if (state.daysRemaining > 0 && state.daysRemaining <= 5) {
    return (
      <div className="fitness-renewal-banner fitness-renewal-upcoming relative overflow-hidden rounded-2xl border border-[#ADFF00]/40 bg-gradient-to-r from-[#1A2619] via-[#121E12] to-[#1A2619] p-4 shadow-[0_0_20px_rgba(173,255,0,0.15)]">
        <div className="flex flex-col justify-between gap-3">
          <div className="flex items-start gap-3">
