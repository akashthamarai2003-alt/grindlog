    ...
    >
      ...
      <div className="flex flex-col gap-3">
        <Link
          ...
          onMouseEnter={() => router.prefetch(`/workout/${workoutId}`)}
          onTouchStart={() => router.prefetch(`/workout/${workoutId}`)}
        ...
        >
          {isResuming ? (
            <>
              ...
              <span className="text-[11px] font-black uppercase tracking-widest">Resuming...</span>
            </>
          ) : (
            <>
