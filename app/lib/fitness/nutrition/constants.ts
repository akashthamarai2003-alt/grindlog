...
export const MEAL_STRUCTURES: Record<string, MealStructure> = {
  "2 meals": {
    slots: [
      { name: "Lunch", type: "lunch", caloriePercent: 0.50 },
      { name: "Dinner", type: "dinner", caloriePercent: 0.50 },
    ],
  },
  "3 meals": {
    slots: [
  ...
  "5+ meals": {
    slots: [
      ...
      { name: "Post-Workout", type: "post_workout", caloriePercent: 0.15 },
      { name: "Dinner", type: "dinner", caloriePercent: 0.20 },
    ],
  },
};
