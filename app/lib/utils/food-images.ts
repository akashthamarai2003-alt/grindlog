...
const FOOD_PHOTO_MAP: Record<string, string> = {
  ...
  "pongal": "https://images.unsplash.com/photo-1610192244261-3f33de3f55e4?w=300&auto=format&fit=crop&q=80",
  ...
  // Curries & Dals
  "sambar": "https://images.unsplash.com/photo-1613292443284-8d10ef9383fe?w=300&auto=format&fit=crop&q=80",
  ...
  "rajma": "https://images.unsplash.com/photo-1588877261965-966964c7d0d0?w=300&auto=format&fit=crop&q=80",
...
const FOOD_AVATAR_CONFIG: Record<string, { emoji: string; colors: [string, string] }> = {
  ...
  "tofu": { emoji: "🧈", colors: ["#EAB308", "#854D0E"] },
  "cheela": { emoji: "🥞", colors: ["#EAB308", "#A16207"] },
  "bhurji": { emoji: "🍳", colors: ["#F59E0B", "#B45309"] },
