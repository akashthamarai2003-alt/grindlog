  ...
  return (
    <div className="flex flex-col gap-7 px-5 pb-8 pt-4 safe-top bg-[var(--color-bg-primary)]">
      ...
      >
        ...
        <div className="absolute inset-0 bg-white/20 dark:bg-black/70 backdrop-blur-[2px]" />
        ...
        <div className="relative z-10 flex items-center justify-between">
          <div className="flex flex-col gap-2">
            <h3 className="text-5xl font-black tracking-tighter text-[var(--color-text-primary)] drop-shadow-sm">
              {completedCount}
              <span className="text-2xl text-[var(--color-text-secondary)]">/{totalCount}</span>
            </h3>
            <p className="text-[15px] font-bold text-[var(--color-text-secondary)] drop-shadow-sm">Done Today ✨</p>
            ...
            <div className="mt-2 flex items-center gap-1.5 w-max rounded-[12px] bg-white/60 dark:bg-white/10 backdrop-blur-md px-3 py-1.5 shadow-sm ring-1 ring-black/5 dark:ring-white/20">
              ...
              <span className="text-xs font-black text-[var(--color-text-primary)] drop-shadow-sm">
          ...
          <div className="relative flex h-[100px] w-[100px] items-center justify-center">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <span className="text-xl font-black text-[var(--color-text-primary)] drop-shadow-sm">{Math.round(progressPct)}%</span>
            </div>
          </div>
        </div>
        
        {/* Level & XP Bar */}
        <div className="relative z-10 mt-8 flex flex-col gap-2.5 rounded-[20px] bg-white/50 dark:bg-black/40 p-4 shadow-sm ring-1 ring-black/5 dark:ring-white/10 backdrop-blur-md">
          <div className="flex items-center justify-between text-[13px] font-black">
            <span className="text-[var(--color-text-primary)] flex items-center gap-1.5 drop-shadow-sm">
              <Sparkles className="h-4 w-4 text-[#FF9500] dark:text-[#FFD60A]" />
              Level {profile.level}
            </span>
            <span className="text-[var(--color-text-secondary)] drop-shadow-sm">Next Level</span>
          </div>
          <div className="h-3 w-full overflow-hidden rounded-full bg-black/10 dark:bg-black/50 shadow-inner ring-1 ring-inset ring-black/5 dark:ring-white/5">
            <div
              className="relative h-full rounded-full bg-gradient-to-r from-[#34C759] via-[#00C7BE] to-[#32ADE6] transition-all duration-1000 ease-out shadow-sm"
          ...
          <div className="flex items-center justify-between text-[11px] font-bold text-[var(--color-text-secondary)] uppercase tracking-wider drop-shadow-sm">
